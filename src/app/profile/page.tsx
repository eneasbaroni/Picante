    ...
    <div id="profile" className="divContainer">
      {status === "authenticated" ? (
        <>
          ...
          (session.user!.role === "admin" ||
            ...
            <>
              ...
              <p>
                Para acceder al mismo u obtener mas informacion y poder
                disfrutar de contenido exclusivo ponte en contaco
              </p>
              <Link
        ...
        <>
          ...
          <p>
            Para acceder a esta sección y poder disfrutar de contenido exclusivo
