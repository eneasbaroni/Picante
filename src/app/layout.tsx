...
export default function RootLayout({
    ...
    return (
        <html lang="es">
            <body
                className={`${anton.variable} ${titilium.variable} ${inter.variable} relative`}
            >
                <Providers>
                    <Header />
                    {children}
