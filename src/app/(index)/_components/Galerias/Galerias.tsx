...
const Galerias = () => {
    ...
    const handleSmileAnimate = async () => {
        //animate(scope.current, {opacity: 0}) //animamos el contenedor entero
        //animate('#smile', {opacity: 0}) //animamos el elemento con id smile
        //await animate('#smile', {scale: 1.3})  //await para que espera terminar la animación antes de comenzar la siguiente
        //await animate('#smile', {rotate: '360deg'}, {duration: 4, ease: 'linear', repeat: Infinity})
    ...
    const handleSmileAnimEnd = async () => {
        //await animate('#smile', {scale: 1})
        //await animate('#smile', {rotate: '0deg'})
    ...
    return (
        ...
        >
            ...
            <p className="font-inter text-xl mobile:text-lg mobile:leading-5 text-center text-balance w-1/2 mobile:w-full mx-auto">
                Entrá a las galerías para ver los diferentes trabajos y la
                &quot;Feria Picante&quot;
            </p>
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <p className="text-white text-base z-20">
                                        {link.text}
                                    </p>
                                </motion.div>
                                <motion.div
            ...
            <Link
                href="/presupuesto"
                className=" w-1/4 tablet:w-56 h-20 mx-auto"
            >
                <motion.div
                    ref={scope}
