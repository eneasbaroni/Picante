...
const links = [
    {
        href: "https://wa.me/+5493516558094",
        alt: "whatsapp",
    ...
    {
        href: "mailto:picante.cba.arg@gmail.com",
        alt: "mail",
        image: "mailIcon.svg",
    },
];
                ...
                <div className="w-full h-[50vh] mobile:h-auto flex mobile:flex-col items-center gap-0 justify-center divide-x divide-main mobile:divide-y mobile:divide-x-0">
                    ...
                    <div className="flex-1 mobile:w-full h-full flex flex-col items-center justify-between   p-4">
                        ...
                        <div className="w-full flex flex-col [&>a]:font-anton [&>a]:text-3xl [&>a]:mobile:text-xl">
                            <Link href="https://wa.me/+5493516558094">
                                +54 9 351-6558094
                            </Link>
                            <Link href="https://www.instagram.com/picante.serigrafia/">
                                @picante.serigrafia
                            </Link>
                            <Link href="mailto:picante.cba.arg@gmail.com">
                                picante.cba.arg@gmail.com
                            </Link>
