...
const Container = ({ work }: { work: IWork | null }) => {
        ...
        <>
            ...
            {selectedImage && (
                ...
                >
                    <div className="relative">
                        <img
                            src={`/Images/works/${work?.id}/${selectedImage}`}
                            alt={`${work?.title} - ${selectedImage}`}
            ...
            <div className="w-full flex flex-row mobile:flex-col gap-2 flex-wrap mt-8 text-center items-stretch">
                ...
                {work?.images.map((image, index) => (
                    <div
                        className="w-[calc(100%/2-0.25rem)] mobile:w-full bg-black aspect-[3/2] hover:p-2 transition-all duration-300 group cursor-pointer"
                        key={index}
