...
const Curso = () => {
    ...
    return (
        <>
            {/* @ts-ignore */}
            {status === "authenticated" && session && session.user != null && session.user != undefined && session.user.role && (session.user!.role === 'admin' || session.user!.role === 'premium') ?
                <div id="curso">
                ...
                loadSession ?
                    ...
                    <div id="curso">
                        <div className="titlesContainer">
                            ...
                            <h3>Inicia sesión y adquiere el curso para poder acceder al material de estudio</h3>
                            <Link href="/profile"><button className="indiceBtn">Iniciar sesión</button></Link>
                        </div>
                    </div>
            }
        </>
